...
int main()
{
    ...
    {
        img1 = imread("/home/pi/Pictures/Testy/blurr/reptile_look_chameleon_73102_800x600.jpg",0);
        img2 = imread("/home/pi/Pictures/Testy/blurr/reptile_look_chameleon_73102_1280x720.jpg",0);
        img3 = imread("/home/pi/Pictures/Testy/blurr/reptile_look_chameleon_73102_1920x1080.jpg",0);
        ...
        timer.start();
        equalizeHist(img2,dest);
        time2 += timer.elapsed();

        timer.start();
        equalizeHist(img3,dest);
        time3 += timer.elapsed();
    }
